...
\usepackage{graphicx}
\usepackage{pgfgantt}
% --- EVITAR EL CORTE DE PALABRAS (GUIONES) ---
\usepackage[none]{hyphenat} % Desactiva la separación de sílabas
\sloppy % Permite a LaTeX ser más flexible con los espacios para evitar que el texto se salga del margen
