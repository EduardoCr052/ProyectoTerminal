...
\section{Antecedentes}
    El monitoreo de energía eléctrica a través de plataformas IoT es un área de investigación y desarrollo activa. Para contextualizar esta propuesta, se han seleccionado y analizado tres trabajos de titulación provenientes de los repositorios digitales de las principales instituciones de educación superior en México.

    \subsection*{    Artículo Internacional: "A Low-Cost Real-Time Non-Intrusive Smart Metering System for Residential Electricity Consumption" }
