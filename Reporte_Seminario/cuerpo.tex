...
\section{Metodología - Descripción Técnica}
    ...
    \subsection{Diagrama a Bloques del Sistema}
        ...
        Estos subsistemas son: 1) Los Nodos de Medición y Adquisición, 2) El Servidor Local de Procesamiento, y 3) El Subsistema de Control y Notificación.
        \begin{figure}[H]
            \centering
...
\section{Cronograma de Actividades}
    ...
    \footnotesize{4. Establ. servidor RPi}       & & & & \cellcolor{gray!40} & \cellcolor{gray!40} & \cellcolor{gray!40} & & & & & & \\ \hline
