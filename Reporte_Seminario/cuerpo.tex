...
\subsection{Objetivos Particulares}
    \begin{enumerate}
        ...
        \item \textbf{Construir} el prototipo físico del nodo de medición, ensamblando el sensor SCT-013, el circuito de acondicionamiento diseñado en el objetivo anterior y el microcontrolador ESP32.
