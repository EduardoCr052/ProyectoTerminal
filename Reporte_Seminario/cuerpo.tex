    ...
    \section{Objetivos}
        ...
        \subsection{Objetivos Específicos}
            \begin{itemize}
                ...
                \item Configurar un servidor local en una Raspberry Pi, implementando un broker MQTT para la recepción de datos, Node-RED para su procesamiento y almacenamiento, y Grafana para la visualización en un panel de control.
